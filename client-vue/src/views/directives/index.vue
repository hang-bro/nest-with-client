<template>
  <main class="w-full h-full overflow-auto no-scroll">
    <header class="bg-gray-300 mb-5 p-4 text-xl font-bold">directives(指令)</header>
    <!-- resize -->
    <section>
      ...
      <div class="preview p-4 bg-gray-50 mt-3 border border-dashed border-gray-400/40 rounded">
        {{ resizeInfo }}
      </div>
    </section>
    ...
    <section>
      ...
      <div
        class="preview p-4 bg-gray-50 mt-3 border border-dashed border-gray-400/40 rounded"
        v-resize="handleResize"
      >
    ...
    <section>
      ...
      <div
        class="p-4 preview bg-gray-50 mt-3 border border-dashed border-gray-400/40 rounded"
        v-resize="handleResize"
      >
        <el-input
          class="!w-[250px]"
    ...
    <section>
      ...
      >
        <div class="w-full">
          <el-button class="w-full" v-throttle="{ callback: handleThrottle }">
            设置(规定时间内只能点击一次)
          </el-button>
        </div>
      </div>
